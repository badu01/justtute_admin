        ...
        <div className="min-h-screen bg-gray-50">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center py-4">
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            >
                                <div className='flex items-center'>
                                    {showSessions ? <FaRegEyeSlash className="mr-2 size-5" /> : <FaRegEye className="mr-2 size-5" />}
            ...
            <main className="max-w-7xl mx-auto ">
                <div className="">
                    ...
                    <div className="bg-white border border-l-0 border-t-0 border-b-0 border-gray-200">
                        <div className="p-8">
                    ...
                    <div className="">
                        ...
                        <div className=" space-y-8">
                            {!showSessions && (<div>
                                ...
                                <div className="bg-white border border-l-0 border-gray-200">
                                    <div className="p-8">
                                ...
                                {/* Assigned Students */}
                                <div className="bg-white border border-l-0 border-t-0 border-gray-200">
                                    <div className="p-8">
                                        ...
                                        {tutor.students && tutor.students.length > 0 ? (
                                            <div className="">
                                                {tutor.students.map((assignment) => (
                                                    <div key={assignment._id} className="flex items-center justify-between py-4 border-b border-gray-200 hover:bg-gray-50">
                                                        <div className="flex items-center space-x-4">
