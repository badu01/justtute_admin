      ...
      <div className="bg-linear-to-r from-blue-600 to-purple-600 p-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-blue-100">Manage tutor subjects and availability</p>
          </div>
          <div className="relative">
            <input
              type="text"
              placeholder="Search tutors..."
              className="pl-10 pr-4 py-2 rounded-lg bg-white bg-opacity-20 text-white placeholder-blue-100 focus:outline-none focus:ring-2 focus:ring-white"
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
            />
            <svg className="absolute left-3 top-2.5 h-5 w-5 text-blue-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
