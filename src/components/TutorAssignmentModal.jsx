...
const TutorAssignmentModal = ({ student, subjects, tutors, onClose, onAssign, isOpen }) => {
  ...
  const handleAssignmentChange = (subject, tutorId) => { const tutor = tutors.find(t => t._id === (tutorId)); setAssignments({ ...assignments, [subject]: tutorId ? { tutorId: tutor._id, tutorName: tutor.name } : null }); };
  ...
  const handleSubmit = () => {
    ...
    onAssign(student.id, formattedAssignments);
  };
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {subjects.map((subject) => {
              ...
              const currentAssignment = student.assignments[subject];
